...
<body>
	...
	<div id="top" align="center">
		...
		<div id="navbarCollapse" class="collapse navbar-collapse">
			<ul id="top_menu">
				<h4 align="center">
					<li><a class="h_menu"href="/final/how/HowTo.jsp">이용방법</a></li>
					<li><a class="c_menu" href="/final/community/community.jsp">커뮤니티</a></li>
					<li><a class="p_menu"href="/final/propensity/propensityTest.jsp">여행취향분석</a></li>
					<li><a class="t_menu"href="/final/travel/travel.jsp">여행지</a></li>
				</h4>
			</ul>
		</div>
	</div>
